...
public abstract class Grammar {
	 ...
	 * @param mediaUri
	 *            Uri of the media file belonging to this Element. If
	 *            {@code null} a zero-length MediaInfo will be created.
	 * @param context
	 *            Context to load the media file
	 * @throws IllegalArgumentException
	 *             If playback of mediaUri is not supported
	 */
	 ...
	 *            Description of the Element
	 * @param mediaResId
	 *            Ressource id of the media file belonging to this Element
	 * @param context
	 *            Context to load the media file
	 */
